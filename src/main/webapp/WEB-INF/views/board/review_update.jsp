...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/temporaryStorage.js"></script>
</head>
<body>
...
<h2>Review</h2>
	<form method="post" action="bdupdate.do"> <!-- 컨트롤러로 감 -->
		<div class="review_write_bg p-5">
            ...
            <div class="input-group">
				...
				<input type="text" name="writer" class="form-control" disabled value="${writer}">
            ...
            <textarea class="form-control mt-3"  id="test" rows="28" name="review_content"></textarea>
        ...
        <button type="button" class="btn list_button mt-2" onclick="location.href='review_list'">목록</button> <!-- 목록으로 이동 -->
	</form>
</div>
<div class="col-md-2"></div>
